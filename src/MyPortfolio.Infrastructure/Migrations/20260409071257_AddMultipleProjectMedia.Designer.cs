...
namespace MyPortfolio.Infrastructure.Migrations
{
    ...
    [Migration("20260409071257_AddMultipleProjectMedia")]
    partial class AddMultipleProjectMedia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyPortfolio.Domain.Projects.Entities.Project", b =>
                {
                    ...
                    b.OwnsMany("MyPortfolio.Domain.Common.ValueObjects.Photo", "Media", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToTable("ProjectMedia", (string)null);
