...
namespace MyPortfolio.Infrastructure.Migrations
{
    ...
    [Migration("20260311070942_RenameProjectImageUrlToMediaUrl")]
    partial class RenameProjectImageUrlToMediaUrl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyPortfolio.Domain.Projects.Entities.Project", b =>
                {
                    ...
                    b.OwnsOne("MyPortfolio.Domain.Common.ValueObjects.Photo", "MediaUrl", b1 =>
                        {
                            b1.Property<Guid>("ProjectId")
                                .HasColumnType("uniqueidentifier");
